...
public class Grenade extends Entity{
    ...
    protected void defineSynchedData(net.minecraft.network.syncher.SynchedEntityData.Builder pBuilder) {
        // No synched data needed for grenade
    }
            ...
            if (this.tickCount <= safeTicks || bounced <= 3) {
                ...
                if (bounced == 0 && CommonConfig.bulletBreakGlass.get()) {
                    ...
                    if (block instanceof IronBarsBlock ||
                        ...
                        (blockKey != null && blockKey.toString().contains("glass"))) {
                ...
                if (this.level().getBlockState(hitResult.getBlockPos()).getBlock() instanceof BellBlock bell && this.shooter instanceof Player) {
                    bell.attemptToRing(null, this.level(), hitResult.getBlockPos(), hitResult.getDirection());
                }
            } else {
                explode();
            }
