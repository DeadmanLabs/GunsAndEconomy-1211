...
public class KeyframeAnimations {
    ...
    public static class SoundPoint{
        public static final ResourceLocation EMPTY_SOUND = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "empty_sound");
        public int tick;
        ...
        public void playSound(boolean soundOnServer) {
            ...
            if (player != null) {
                ...
                if (soundOnServer) {
                    PacketDistributor.sendToServer(new PlayerSoundPacket(soundName.toString()));
                }
            }
        }
    }
