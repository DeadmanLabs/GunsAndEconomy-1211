        ...
        registerGunModelSupplier("COMMON_RIFLE_MODEL", (def, addon) -> {
            ...
            if (def.has("geo_low") && def.has("texture_low")) {
                ...
                return new CommonRifleModel(
                        ResourceLocation.fromNamespaceAndPath(id, geo),
                        ResourceLocation.fromNamespaceAndPath(id, animation),
                        ResourceLocation.fromNamespaceAndPath(id, texture),
                        ResourceLocation.fromNamespaceAndPath(id, geo_low),
                        ResourceLocation.fromNamespaceAndPath(id, texture_low));
            } else {
                return new CommonRifleModel(
                        ResourceLocation.fromNamespaceAndPath(id, geo),
                        ResourceLocation.fromNamespaceAndPath(id, animation),
