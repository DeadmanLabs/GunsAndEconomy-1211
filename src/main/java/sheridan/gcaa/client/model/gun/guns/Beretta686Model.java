...
public class Beretta686Model extends GunModel {
    ...
    public Beretta686Model() {
        super(ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/beretta_686/beretta_686.geo.json"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/beretta_686/beretta_686.animation.json"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/beretta_686/beretta_686.png"));
    }
