...
public class Vector45Model extends CommonRifleModel {
    ...
    public Vector45Model() {
        super(ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/vector_45/vector_45.geo.json"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/vector_45/vector_45.animation.json"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/vector_45/vector_45.png"));
    }
