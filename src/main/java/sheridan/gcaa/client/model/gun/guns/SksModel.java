...
public class SksModel extends AutoShotGunModel {
    ...
    public SksModel() {
        super(ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/sks/sks.geo.json"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/sks/sks.animation.json"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/sks/sks.png"), null, null);
    }
