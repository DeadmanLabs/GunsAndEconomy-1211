...
public class Mk47Model extends CommonRifleModel {
    ...
    public Mk47Model() {
        super(ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/mk47/mk47.geo.json"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/mk47/mk47.animation.json"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/mk47/mk47.png"));
    }
