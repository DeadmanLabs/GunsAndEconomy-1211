...
public class GltfLoader {
    ...
    protected static void buildPivots(BufferedModelBone bone, Map<BufferedModelBone, Vector3f> pivots, PoseStack poseStack) {
        poseStack.pushPose();
        bone.translateAndRotate((PoseStack) poseStack);
    ...
    protected static void loadMesh(Mesh mesh, Map<Integer, BufferedModelBone> boneMap, Map<BufferedModelBone, Vector3f> pivots) {
        ...
        for (int i = 0; i < indices.length; i++) {
            ...
            if (bone.meshData == null) {
                bone.meshData = new BufferedModelBone.BoneMeshData();
            }
...
//            }
    ...
    public static void test() {
        BufferedModelBone.TEST = loadModel(ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/test_gltf/m1a2.gltf"));
        ResourceLocation texture = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/test_gltf/m1a2.png");
