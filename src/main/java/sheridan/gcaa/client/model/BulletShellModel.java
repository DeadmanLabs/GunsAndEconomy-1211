...
public class BulletShellModel {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/bullet_shell.png");
    public static final String PISTOL = "pistol", RIFLE = "rifle", SHOTGUN = "shotgun";
    public ModelPart root;

    private BulletShellModel() {
        root = ArsenalLib.loadBedRockGunModel(ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/bullet_shell.json")).bakeRoot().getChild("root");
    }
