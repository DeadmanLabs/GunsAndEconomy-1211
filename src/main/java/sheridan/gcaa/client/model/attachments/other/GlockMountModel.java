...
public class GlockMountModel implements IAttachmentModel, ISlotProviderModel {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/others/glock_mount.png");
    ...
    public GlockMountModel() {
        root = ArsenalLib.loadBedRockGunModel(
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/others/glock_mount.geo.json")).bakeRoot().getChild("root");
        root.meshingAll();
