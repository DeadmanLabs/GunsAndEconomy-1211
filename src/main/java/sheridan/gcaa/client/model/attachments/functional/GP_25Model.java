...
public class GP_25Model extends GrenadeLauncherModel {
    public GP_25Model() {
        super(ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/functional/gp_25/gp_25.png"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/functional/gp_25/gp_25.geo.json"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/functional/gp_25/reload_rifle.animation.json"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/generic/gp_25_reload_ak_rifle.animation.json"),
