...
public class ARRailedHandguardModel implements IAttachmentModel, ISlotProviderModel {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/ar_stuff/ar_railed_handguard.png");

    public ARRailedHandguardModel() {
        root = ArsenalLib.loadBedRockGunModel(
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/ar_stuff/ar_railed_handguard.geo.json")).bakeRoot().getChild("root");
