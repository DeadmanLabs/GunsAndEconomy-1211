...
public class SightViewRenderer {
    private static final ResourceLocation DEFAULT_SCOPE_BACKGROUND = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/scopes/default_scope_background.png");
    private static final ByteBufferBuilder SCOPE_VIEW_BUFFER = new ByteBufferBuilder(256 * 256);
