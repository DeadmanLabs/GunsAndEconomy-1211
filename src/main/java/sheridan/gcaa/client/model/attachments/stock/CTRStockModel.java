...
public class CTRStockModel implements IAttachmentModel {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/stocks/ctr_stock.png");

    public CTRStockModel() {
        this.root = ArsenalLib.loadBedRockGunModel(
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/stocks/ctr_stock.geo.json")).bakeRoot().getChild("root").meshing();
