...
public class VerticalGripModel extends CommonGripModel {
    @Override
    protected void init() {
        root = ArsenalLib.loadBedRockGunModel(ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/grips/vertical_grip.geo.json")).bakeRoot().getChild("root");
        ...
        texture = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/grips/vertical_grip.png");
