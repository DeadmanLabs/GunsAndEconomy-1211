...
public class AcogModel extends ScopeModel implements ISlotProviderModel {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/scopes/acog/acog.png");
    private static final ResourceLocation CROSSHAIR_TEXTURE = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/scopes/acog/acog_crosshair.png");

    public AcogModel() {
        super(ArsenalLib.loadBedRockGunModel(
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/scopes/acog/acog.geo.json")).bakeRoot().getChild("root"));
