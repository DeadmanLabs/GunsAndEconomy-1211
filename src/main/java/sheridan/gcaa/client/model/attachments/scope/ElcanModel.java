...
public class ElcanModel extends ScopeModel {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/scopes/elcan/elcan.png");
    private static final ResourceLocation CROSSHAIR_TEXTURE = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/scopes/elcan/elcan_crosshair.png");

    public ElcanModel() {
        super(ArsenalLib.loadBedRockGunModel(
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/scopes/elcan/elcan.geo.json")).bakeRoot().getChild("root"));
