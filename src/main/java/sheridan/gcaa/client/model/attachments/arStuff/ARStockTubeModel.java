...
public class ARStockTubeModel implements IAttachmentModel, ISlotProviderModel {
    ...
    private final ResourceLocation texture_low = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/ar_stuff/gas_block_stock_tube_low.png");
