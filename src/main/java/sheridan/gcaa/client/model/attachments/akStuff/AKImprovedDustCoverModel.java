...
public class AKImprovedDustCoverModel implements IAttachmentModel, ISlotProviderModel {
    ...
    private final ResourceLocation texture = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/ak_stuff/improved_dust_cover.png");

    public AKImprovedDustCoverModel() {
        this.root = ArsenalLib.loadBedRockGunModel(ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/ak_stuff/improved_dust_cover.geo.json"))
