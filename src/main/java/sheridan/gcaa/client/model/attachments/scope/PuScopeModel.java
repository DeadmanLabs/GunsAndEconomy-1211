...
public class PuScopeModel extends ScopeModel {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/scopes/pu_scope/pu_scope.png");
    private static final ResourceLocation CROSSHAIR_TEXTURE = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/scopes/pu_scope/crosshair.png");

    public PuScopeModel() {
        super(ArsenalLib.loadBedRockGunModel(
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/scopes/pu_scope/pu_scope.geo.json")).bakeRoot().getChild("root"));
