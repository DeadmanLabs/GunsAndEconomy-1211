...
public class M203Model extends GrenadeLauncherModel{
    ...
    public M203Model() {
        super(ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/functional/m203/m203.png"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/functional/m203/m203.geo.json"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/attachments/functional/m203/reload.animation.json"),
                ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "model_assets/guns/generic/m203_reload_m4a1_rifle.animation.json"),
                null, null);
    }
