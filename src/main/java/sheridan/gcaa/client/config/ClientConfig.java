...
public class ClientConfig {
    ...
    public static ModConfigSpec.BooleanValue renderAttachmentsInGuiView;
    public static ModConfigSpec.BooleanValue renderAttachmentsInGroundView;
    public static ModConfigSpec.BooleanValue renderVanillaModelInGroundView;
    public static ModConfigSpec.BooleanValue enableMuzzleFlashScaleModifyOnUsingScope;
    public static ModConfigSpec.BooleanValue renderLowQualityModelInTPView;
    public static ModConfigSpec.BooleanValue renderLowQualityModelInGroundView;
    public static ModConfigSpec.BooleanValue renderLowQualityModelInOtherView;
    public static ModConfigSpec.BooleanValue enableMuzzleFlashLighting;
