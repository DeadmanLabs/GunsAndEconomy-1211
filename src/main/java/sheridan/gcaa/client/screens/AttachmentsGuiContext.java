...
public class AttachmentsGuiContext {
    ...
    private static final ResourceLocation EMPTY = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "textures/gui/screen/empty.png");
    private static final ResourceLocation OCCUPIED = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "textures/gui/screen/occupied.png");
    private static final ResourceLocation EMPTY_SELECTED = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "textures/gui/screen/empty_selected.png");
    private static final ResourceLocation OCCUPIED_SELECTED = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "textures/gui/screen/occupied_selected.png");
