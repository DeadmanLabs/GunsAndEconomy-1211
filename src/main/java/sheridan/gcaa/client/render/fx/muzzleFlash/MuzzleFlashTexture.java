...
public class MuzzleFlashTexture {
    ...
    private void drawQuad(VertexConsumer builder, Matrix4f matrix, float u1, float v1, float u2, float v2) {
        builder.addVertex(matrix, -0.5f, 0.5f, 0.0F).setColor(1.0F, 1.0F, 1.0F, BASE_ALPHA).setUv(u2, v2).setLight(157288880).setOverlay(655360);
        builder.addVertex(matrix, 0.5f, 0.5f, 0.0F).setColor(1.0F, 1.0F, 1.0F, BASE_ALPHA).setUv(u1, v2).setLight(157288880).setOverlay(655360);
        builder.addVertex(matrix, 0.5f, -0.5f, 0.0F).setColor(1.0F, 1.0F, 1.0F, BASE_ALPHA).setUv(u1, v1).setLight(157288880).setOverlay(655360);
        builder.addVertex(matrix, -0.5f, -0.5f, 0.0F).setColor(1.0F, 1.0F, 1.0F, BASE_ALPHA).setUv(u2, v1).setLight(157288880).setOverlay(655360);
    }
}
