...
public class MuzzleSmoke {
    ...
    protected void draw(Matrix4f matrix, VertexConsumer vertexConsumer, float alpha, int column, int index, int light) {
        ...
        float v2 = v1 + 0.25f;
        vertexConsumer.addVertex(matrix, -0.5f, 0.5f, 0.0F).setColor(1.0F, 1.0F, 1.0F, alpha).setUv(u1, v1).setLight(light).setOverlay(655360);
        vertexConsumer.addVertex(matrix, 0.5f, 0.5f, 0.0F).setColor(1.0F, 1.0F, 1.0F, alpha).setUv(u2, v1).setLight(light).setOverlay(655360);
        vertexConsumer.addVertex(matrix, 0.5f, -0.5f, 0.0F).setColor(1.0F, 1.0F, 1.0F, alpha).setUv(u2, v2).setLight(light).setOverlay(655360);
        vertexConsumer.addVertex(matrix, -0.5f, -0.5f, 0.0F).setColor(1.0F, 1.0F, 1.0F, alpha).setUv(u1, v2).setLight(light).setOverlay(655360);
    }
}
