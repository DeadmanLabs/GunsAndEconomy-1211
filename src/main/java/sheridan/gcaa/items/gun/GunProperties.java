...
public class GunProperties implements IJsonSyncable {
    ...
    public DeferredHolder<SoundEvent, SoundEvent> fireSound;
    public DeferredHolder<SoundEvent, SoundEvent> suppressedSound;
    ...
    public GunProperties(float adsSpeed, float minSpread, float maxSpread, float shootSpread, float spreadRecover, float fireSoundVol, int fireDelay, int reloadLength, int fullReloadLength,
                         ...
                         DeferredHolder<SoundEvent, SoundEvent> fireSound, @Nullable DeferredHolder<SoundEvent, SoundEvent> suppressedSound, Caliber caliber) {
