...
public class Caliber implements IJsonSyncable {
    public static final ResourceLocation CALIBER_762X39MM = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "7.62x39mm");
    public static final ResourceLocation CALIBER_556X45MM = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "5.56x45mm");
    public static final ResourceLocation CALIBER_545X39MM = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "5.45x39mm");
    public static final ResourceLocation CALIBER_9MM = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "9mm");
    public static final ResourceLocation CALIBER_762X51MM = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "7.62x51mm");
    public static final ResourceLocation CALIBER_357_MAGNUM = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, ".357_magnum");
    public static final ResourceLocation CALIBER_12_GAUGE = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "12_gauge");
    public static final ResourceLocation CALIBER_45_ACP = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, ".45_acp");
    public static final ResourceLocation CALIBER_338_LAPUA_MAGNUM = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, ".338_lapua_magnum");
    public static final ResourceLocation CALIBER_57X28MM = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "5.7x28mm");
    public static final ResourceLocation CALIBER_68X51MM = ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "6.8x51mm");
    ...
    public void loadData(JsonObject jsonObject) {
        name = ResourceLocation.parse(jsonObject.get("name").getAsString());
