...
public class Annihilator extends Gun {
    ...
    @Override
    protected void gunDetailInfo(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flagIn) {
        super.gunDetailInfo(stack, context, tooltip, flagIn);
