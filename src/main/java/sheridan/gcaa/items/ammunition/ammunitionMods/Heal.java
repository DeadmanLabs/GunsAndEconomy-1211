...
public class Heal extends AmmunitionMod {
    ...
    public Heal() {
        super(ResourceLocation.fromNamespaceAndPath(GCAA.MODID, "heal"), 10, ICONS_0, new Vector4i(64, 0, 128, 128),
    ...
    public Component getSpecialDescription() {
        ...
        String res = str.replace("$rate", FontUtils.toPercentageStr(HEAL_RATE))
                ...
                .replace("$effect", Component.translatable(MobEffects.REGENERATION.value().getDescriptionId()).getString());
