...
public class ModTabs {
    ...
    public static final Supplier<CreativeModeTab> GUNS_TAB;
    public static final Supplier<CreativeModeTab> ATTACHMENTS_TAB;
    public static final Supplier<CreativeModeTab> AMMUNITION_TAB;
    /** 杂项物品注册 */
    public static final Supplier<CreativeModeTab> OTHER_TAB;
    static {
