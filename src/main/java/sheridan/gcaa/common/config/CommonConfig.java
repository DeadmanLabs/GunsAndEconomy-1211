...
public class CommonConfig {
    ...
    public static ModConfigSpec.BooleanValue enableLagCompensation;
    public static ModConfigSpec.IntValue maxLagCompensationMilliseconds;
    public static ModConfigSpec.IntValue initialBulletPoolSize;
    public static ModConfigSpec.IntValue maxBulletLivingTime;
    public static ModConfigSpec.BooleanValue enableKnockBackToEntity;
    public static ModConfigSpec.BooleanValue enableKnockBackToPlayer;
    public static ModConfigSpec.DoubleValue globalBulletSpeedModify;
    public static ModConfigSpec.DoubleValue globalBulletDamageModify;
    public static ModConfigSpec.ConfigValue<List<? extends String>> headshotModify;
    public static ModConfigSpec.BooleanValue enableHeadShot;
    public static ModConfigSpec.BooleanValue bulletBreakGlass;
    public static ModConfigSpec.BooleanValue bulletCrossLeafBlock;
    public static ModConfigSpec.BooleanValue creativeModeUseAmmo;
